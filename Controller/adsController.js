...
module.exports.newsAds = async(req, res)=>{
    const sql1 = 'SELECT content FROM `ads` WHERE content<>"" and status=1 and section=6 and DATE_FORMAT(curtime(), "%H:%i")>=from_hr and DATE_FORMAT(curtime(), "%H:%i")<=to_hr limit 1';
    const sql2 = 'SELECT content FROM `ads` WHERE content<>"" and status=1 and section=7 and DATE_FORMAT(curtime(), "%H:%i")>=from_hr and DATE_FORMAT(curtime(), "%H:%i")<=to_hr limit 1;';
    const sql3 = 'SELECT content FROM `ads` WHERE content<>"" and status=1 and section=8 and DATE_FORMAT(curtime(), "%H:%i")>=from_hr and DATE_FORMAT(curtime(), "%H:%i")<=to_hr limit 1;';
...
module.exports.newsDetails = async(req, res)=>{
    const sql1 = 'SELECT content FROM `ads` WHERE content<>"" and status=1 and section=9 and DATE_FORMAT(curtime(), "%H:%i")>=from_hr and DATE_FORMAT(curtime(), "%H:%i")<=to_hr limit 1';
    const sql2 = 'SELECT content FROM `ads` WHERE content<>"" and status=1 and section=10 and DATE_FORMAT(curtime(), "%H:%i")>=from_hr and DATE_FORMAT(curtime(), "%H:%i")<=to_hr limit 1;';
    const sql3 = 'SELECT content FROM `ads` WHERE content<>"" and status=1 and section=11 and DATE_FORMAT(curtime(), "%H:%i")>=from_hr and DATE_FORMAT(curtime(), "%H:%i")<=to_hr limit 1;';
